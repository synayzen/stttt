...
mongoose.connect('mongodb+srv://AliEmre:1708ali1708@cluster0.gjbfe.mongodb.net/statbot?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true});
...
client.login(process.env.TOKEN).then(x => console.log(`Bot ${client.user.tag} olarak giriş yaptı!`)).catch(err => console.error(`Bot ${client.user.tag} giriş yapamadı | Hata: ${err}`));
